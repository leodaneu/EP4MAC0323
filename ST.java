...
public class ST<Key extends Comparable<Key>, Value> implements Iterable<Key> {
    ...
    public static void main(String[] args) {
       ...
       // insert some key-value pairs
        ...
        StdOut.println(st.get("www.cs.princeton.edu"));     // prints IP address of princeton
        StdOut.println(st.get("www.harvardsucks.com"));     // returns null
        StdOut.println(st.get("www.simpsons.com"));         // again, returns IP address
        StdOut.println();
        // returns the approximated value of these addresses
